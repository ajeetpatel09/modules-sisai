...
function App() {
  ...
  return (
    <>
      ...
      <NavLink to='/' style={{color: 'inherit'}}><h3>5. Excel sheet creation from backend and frontend</h3></NavLink>
      <NavLink to='/pdfCreation' style={{color: 'inherit'}}><h3>6. pdf creation at frontend</h3></NavLink>
      <NavLink to='/' style={{color: 'inherit'}}><h3>7. Chart rendering</h3></NavLink>
      <NavLink to='/' style={{color: 'inherit'}}><h3>8. Geocoding</h3></NavLink>
      ...
      <NavLink to='/' style={{color: 'inherit'}}><h3>11. Maps rendering</h3></NavLink>
    </>
  )
}
